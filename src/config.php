...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/prj_membership.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "uU+bB/eu+TVWONcsmIwYd8XMjpOrMzbMxfQ2nyyRtUg=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_membership\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\prj_membership\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-2118a31f-9792-4a53-a578-dd31894048f9", // Export folder
    ...
    "USE_MODAL_LOGIN" => true, // Use modal login
    ...
    "REGISTER_ACTIVATE_PROPERTY_NAME" => "activated",
    "REGISTER_ACTIVATE_FIELD_VALUE" => "Y",
    ...
    // Email
    "SENDER_EMAIL" => "info@projectlearning.id", // Sender email address
