...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "", "dbname" => "db_membership"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "uU+bB/eu+TVWONcsmIwYd8XMjpOrMzbMxfQ2nyyRtUg=", // JWT secret key
